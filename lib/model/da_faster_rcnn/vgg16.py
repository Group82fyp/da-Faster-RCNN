...
class vgg16(_fasterRCNN):
  def __init__(self, classes, pretrained=False, class_agnostic=False):
    ...
    self.new_model_path = './trained_model/vgg16/cityscape/24_4_240.pth'
  ...
  def _init_modules(self):
    ...
    if self.pretrained:
        print("Loading pretrained weights from %s" %(self.new_model_path))
        state_dict = torch.load(self.new_model_path)
